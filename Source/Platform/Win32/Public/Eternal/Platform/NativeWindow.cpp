...
namespace
{
    ...
    WindowHandle WrapWindowHandle(const std::shared_ptr<NativeWindowHandle> &nativeHandle, const std::shared_ptr<EventBuffer> &eventBuffer)
    {
        return {
    ...
    public:
        ...
        WindowHandle CreateWindowHandle(const WindowSettings &settings)
        {
            ...
            return WrapWindowHandle(nativeHandle, events);
        }
